...
public static class RenamePlanner
{
    ...
    /// keystroke in the hashtag or leading-characters box.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public static IReadOnlyList<RenamePlanItem> Plan(RenameFolderSnapshot snapshot, string? hashtagText, int removeLeadingCount = 0)
    {
        ...
        {
            var desiredName = VideoNameRules.ComposeName(fileName, hashtags, out var idFound, removeLeadingCount);
